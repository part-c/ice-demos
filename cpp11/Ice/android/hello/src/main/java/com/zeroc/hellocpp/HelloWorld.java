...
public class HelloWorld extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        useDiscoveryCheckBox.setVisibility(View.INVISIBLE); // TODO: Enable when IceDiscovery is supported

        sayHelloButton.setOnClickListener(new OnClickListener()
        {
            public void onClick(android.view.View v)
            {
                int mode = _app.getDeliveryMode();
                if(mode == HelloApp.DELIVERY_MODE_ONEWAY_BATCH ||
                   mode == HelloApp.DELIVERY_MODE_ONEWAY_SECURE_BATCH ||
                   mode == HelloApp.DELIVERY_MODE_DATAGRAM_BATCH)
                {
        ...
        _app.setDeliveryMode((int)modeSpinner.getSelectedItemId());
            ...
            public void handleMessage(Message m)
            {
                switch(m.what)
                {
                    ...
                    case HelloApp.MSG_EXCEPTION:
                    {
                        ...
                        DialogFragment dialog = ErrorDialogFragment.newInstance(error, false);
