...
command similar to:
```
set PATH=%USERPROFILE%\ice-demos\cpp98\packages\zeroc.ice.v143.8.0a0\build\native\bin\x64\Debug;%USERPROFILE%\ice-demos\cpp98\packages\zeroc.ice.v143.8.0a0\build\native\bin\x64\Release;%PATH%
```
