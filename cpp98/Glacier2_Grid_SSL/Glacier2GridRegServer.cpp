...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        string tcp_value = "tcp -h localhost";
        // initData.properties->setProperty(taskIceServantAdapterName + ".Endpoints", tcp_value);
        initData.properties->setProperty(taskIceServantAdapterName + ".AdapterId", taskIceServantAdapterId);
        // 设置SSL
        string ssl_value = "ssl -h localhost";
        initData.properties->setProperty(taskIceServantAdapterName + ".Endpoints", ssl_value);
        ...
        // initData.properties->setProperty("IceSSL.Keychain", "server.key");
